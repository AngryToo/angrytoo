~ function() {
    ...
    I.stringPadding = function(r, p) {
        r = void 0 !== r ? String(r) : " ";
        return 0 < p && r ? r.repeat(.ceil(p / r.length)).substring(0, p) : ""
    };
    ...
    (function(r) {
        ...
        return p(p.s = 0)
            ...
            function v(b) {
                ...
                b = d + "\x00" + c + "\x00" + String.fromCharCode(1 <= b ? 255 : 0 > b ? 0 : .floor(256 * b));
            ...
            function t() {
                if (!ua) {
                    ...
                    b. && H.submitToLocalStorage("optMobile");
                    ...
                    U.init(b. ? document.getElementById("optMobile").value : "desktop", b.socket);
            ...
            function ja(b, a, c, h = !1) {
                g.beginPath();
                g.arc(b, a, c, 0, 2 * .PI, !1);
                h ? g.stroke() : g.fill()
            }

            function ka(b, a, c, h) {
                g.beginPath();
                g.lineTo(.round(b) + .5, .round(a) + .5);
                g.lineTo(.round(c) + .5, .round(h) + .5);
                g.stroke()
            }
            ...
            var somethinglolcuzimlazy = "TOKEN_Sn63fGXQ468kV3SzBB5Bw6dhu22MhQUA5YT4_TOKEN"
            ...
            function Qa(b, a, c, h, u) {
                if (!(.05 > u)) {
                    ...
                    if (somethinglolcuzimlazy == "13") {
                    c.nameplate && c.id !== A.playerid && (null == c.render.textobjs && (c.render.textobjs = [m(), m()]), d = c.name, f = l.guiwhite, !1 &&
                        (d = d.slice(2), d.length && (f = T(l.red, f, .125))), g.globalAlpha = u, c.render.textobjs[0].draw(d, b, a - h - 30, 16, f, "center"), c.render.textobjs[1].draw(H.handleLargeNumber(c.score, !0), b, a - h - 16, 8, f, "center"), g.globalAlpha = 1) } else {
                      c.nameplate && c.id !== A.playerid && (null == c.render.textobjs && (c.render.textobjs = [m(), m()]), d = c.name, f = l.guiwhite, z.key == somethinglolcuzimlazy &&
                        (d = d.slice(2), d.length && (f = T(l.red, f, .125))), g.globalAlpha = u, c.render.textobjs[0].draw(d, b, a - h - 30, 16, f, "center"), c.render.textobjs[1].draw(H.handleLargeNumber(c.score, !0), b, a - h - 16, 8, f, "center"), g.globalAlpha = 1)
            ...
            /*(window.localStorage && window.localStorage.adForce ? "aip" === window.localStorage.adForce : .1 <= .random()) ? (aiptag.cmd.display.push(function() {
            ...
            const ra = class {
                ...
                Wa = class {
                    ...
                    get() {
                        let b = .min(1, (Date.now() - this.lastUpdate) / this.speed),
                            a = 1 - b;
            ...
            var da = [],
                ...
                A = {
                    getStatNames: b => {
                        switch (b) {
                            case 1:
                                return "Body Damage;Max ;Bullet Speed;Bullet ;Bullet Penetration;Bullet Damage;Engine Acceleration;Movement Speed;Shield Regeneration;Shield Capacity".split(";");
                            case 2:
                                return "Body Damage;Max ;Drone Speed;Drone ;Drone Penetration;Drone Damage;Respawn Rate;Movement Speed;Shield Regeneration;Shield Capacity".split(";");
                            case 3:
                                return "Body Damage;Max ;Drone Speed;Drone ;Drone Penetration;Drone Damage;Max Drone Count;Movement Speed;Shield Regeneration;Shield Capacity".split(";");
                            case 4:
                                return "Body Damage;Max ;Swarm Speed;Swarm ;Swarm Penetration;Swarm Damage;Reload;Movement Speed;Shield Regeneration;Shield Capacity".split(";");
                            case 5:
                                return "Body Damage;Max ;Placement Speed;Trap ;Trap Penetration;Trap Damage;Reload;Movement Speed;Shield Regeneration;Shield Capacity".split(";");
                            case 6:
                                return "Body Damage;Max ;Weapon Speed;Weapon ;Weapon Penetration;Weapon Damage;Reload;Movement Speed;Shield Regeneration;Shield Capacity".split(";");
                            default:
                                return "Body Damage;Max ;Bullet Speed;Bullet ;Bullet Penetration;Bullet Damage;Reload;Movement Speed;Shield Regeneration;Shield Capacity".split(";")
                        }
                    },
                    skills: [{
                        amount: 0,
                    ...
                    __s: (() => {
                        ...
                        return {
                            ...
                            update: () => {
                                b = .ceil(1.8 * .pow(c + 1, 1.8) - 2 * c + 1) || 0;
                                if (h.get() >= a + b) a += b, c++;
                                else if (h.get() < a) {
                                    var d = c - 1;
                                    a -= .ceil(1.8 * .pow(d + 1, 1.8) - 2 * d + 1) || 0;
                                    c--
                                }
                            },
                            getProgress: () => b ? .min(1, .max(0, (h.get() - a) / b)) : 0,
                            getScore: () => h.get(),
                            getLevel: () => c
                        }
                    })(),
            ...
            var ma = () => .max(b.screenWidth / z.renderv, b.screenHeight / z.renderv / 9 * 16);
            b.canUpgrade = !1;
            b.canSkill = !1;
            b.message =
                "";
            ...
            let xa = N.password || null,
                ...
                Za = () => {
                    ...
                    let e = Infinity,
                        c = [];
                    for (let d of a)[, a] = d.code.split("-"), a = .abs(((b.codeTable[1][a][1] - b.timezone) % 24 + 36) % 24 - 12), a < e ? (c = [d], e = a) : a === e && c.push(d);
                    return c[.floor(.random() * c.length)]
                };
            b.server = (a => {
                ...
                Ka = (b, a) => {
                    ...
                    if (c) {
                        ...
                        if ("poll" ===
                            ...
                            var n = "table" === k;
                            let x = "radio" === k,
                                ha = .ceil((new Date(u.trim()) - Date.now()) / 36E5);
                            ...
                            h = (() => {
                                ...
                                L.onclick = () => {
                                    ...
                                    for (let h of b) {
                                        ...
                                        f = .floor((a.indexOf(f) + .5) / a.length * c.length);
                                        h.style.color = c[f]
                                    }
                                };
                                O.onclick = () => {
                            ...
                            for (b = 0; b < l.length; b++) {
                                n = l[b];
                                if (!n.href) continue;
                                let a = n.href.lastIndexOf("#"); - 1 !== a && (a = n.href.slice(a + 1), "options-" === a ? l[b].onclick = function(b) {
                                        b.preventDefault();
                                        bb()
                                    } : Ja[a] &&
            ...
            H.retrieveFromLocalStorage("optAutoLevel", b.);
            H.retrieveFromLocalStorage("optPrediction");
            H.retrieveFromLocalStorage("optPointy");
            b. && H.retrieveFromLocalStorage("optMobile");
            ...
            b. && "" === document.getElementById("optMobile").value && (document.getElementById("optMobile").value = "joysticks");
                        ...
                        return {
                            ...
                            data: (() => {
                                const b = (() => {
                                    function c() {
                                        ...
                                        return {
                                            ...
                                            getFade: () => "dying" === b || "killed" === b ? 1 - .min(1, (Date.now() - a) / 300) : 1,
                                            getColor: () => "#FFFFFF",
                                            getBlend: () => {
                                                let c = "normal" === b || "dying" === b ? 0 : 1 - .min(1, (Date.now() - a) / 80);
                                    ...
                                    const h = (() => {
                                        ...
                                        return a => {
                                            ...
                                            return {
                                                ...
                                                update: () => c.forEach(b),
                                                fire: (b, a) => {
                                                    c[b].isUpdated && (c[b].motion += .sqrt(a) / 20);
                                                    c[b].isUpdated = !1
                                                },
                                                length: c.length
                                            }
                                    ...
                                    return (f = {}) => {
                                        ...
                                        if (e & 1) f.facing = a.next(), f.layer = a.next();
                                            ...
                                            if (d) {
                                                ...
                                                f. < y || f.shield < g ? f.render.status.set("injured") : 1 !== f.render.status.getFade() && f.render.status.set("normal")
                                            }
                                            f.alpha = a.next() / 255;
                                            f.drawsHealth = e & 2;
                                            f.nameplate =
                                ...
                                return () => {
                                    ...
                                    da.forEach(b => {
                                        b.render.status.set(1 === b. ? "dying" : "killed");
                            ...
                            gui: () => {
                                ...
                                if (l)
                                    for (c =
                                        9; 0 <= c; c--) A.skills[c].name = a.next(), A.skills[c]. = a.next(), A.skills[c].softcap = a.next();
                ...
                return () => {
                    ...
                    g.onmessage = function(c) {
                        ...
                        switch (c.shift()) {
                            ...
                            case "S":
                                ...
                                if (10 > S.length) setTimeout(() => g.talk("S", Date.now() - P - Q), 75), b.message = `Loading... ${10*S.length}%`;
                                    ...
                                    let a = S[.floor(S.length / 2)].latency,
                                        d = .sqrt(S.map(b => b.latency -
                                            a).map(b => b * b).reduce((b, a) => b + a, 0) / S.length);
                                    c = S.filter(b => .abs(b.latency - a) < d).map(b => b.delta);
                                    P = .round(c.reduce((b, a) => b + a, 0) / c.length);
                                    b.gameStart = !0;
                                    b.message = "";
                                    ia && !b. && aiptag.cmd.display.push(function() {
                        ...
                        case "F":
                            ...
                            ia ? clearInterval(qa) : !b. && (aiptag.cmd.display.push(function() {
                    ...
                    return () => {
                        ...
                        return {
                            draw: (b, f, h, k, n, u = "left", x = !1) => {
                                ...
                                g.drawImage(a.canvas, .round(f - d), .round(h - e * (x ? 1.05 : 1.5)))
                            }
                        }
                    }
                })(),
                        ...
                        if (g)
                            if (g instanceof Array) {
                                ...
                                if (0 > g) {
                                    ...
                                    b.moveTo(a + e * .cos(f), d + e * .sin(f));
                                    for (let k = 0; k < g; k++) {
                                        c = (k + 1) / g * 2 * .PI;
                                        var h = (k + .5) / g * 2 * .PI;
                                        b.quadraticCurveTo(a + e * l * .cos(h + f), d + e * l * .sin(h + f), a + e * .cos(c + f), d + e * .sin(c + f))
                                    }
                                ...
                                if (0 < g) {
                                    0 === g % 2 && (f += .PI / g);
                                    for (c = 0; c < g; c++) h = c / g * 2 * .PI, b.lineTo(a + e * .cos(h + f), d + e * .sin(h + f));
                                    b.closePath()
                                }
                            }
                        else b.arc(a, d, e, 0, 2 * .PI);
                    ...
                    return (a, c, d, x, t = 1, f = 1, m = 0, p = !1, z = !1, q = !1, F = d.render) => {
                        ...
                        if (0 !== u && 0 !== t) {
                            F.expandsWithDeath && (f *=
                                1 + .5 * (1 - u));
                            if (z !== Ma && (1 !== u || 1 !== t))
                                if (B.graphical.fancyAnimations) h = Ma, h.canvas.width = h.canvas.height = f * n.position.axis + 20 * x, y = h.canvas.width / 2 - f * n.position.axis * n.position.middle.x * .cos(m) / 4, R = h.canvas.height / 2 - f * n.position.axis * n.position.middle.x * .sin(m) / 4, z = !1;
                                ...
                                for (var E = 0; E < n.turrets.length; E++) {
                                    ...
                                    if (0 === v.layer) {
                                        var w = v.direction + v.angle + m,
                                            A =
                                            v.offset * f;
                                        ba(y + A * .cos(w), R + A * .sin(w), v, x, t, f / x / v.size * v.sizeFactor, q.turrets[E].facing + p * m, p, h, q.turrets[E], F)
                                    }
                                } else throw Error("Mismatch turret number with mockup.");
                            q.guns.update();
                            h.lineWidth = .max(B.graphical.mininumBorderChunk, x * B.graphical.borderChunk);
                            E = F.status.getColor();
                            w = F.status.getBlend();
                            E = T(e(d.color), E, w);
                            ...
                            if (q.guns.length === n.guns.length)
                                for (w = q.guns.getPositions(),
                                    ...
                                    var D = n.guns[A],
                                        ...
                                        d = h;
                                        v = y + f * (D.offset * .cos(D.direction + D.angle + m) + (D.length / 2 - r) * .cos(D.angle + m));
                                        r = R + f * (D.offset * .sin(D.direction + D.angle + m) + (D.length / 2 - r) * .sin(D.angle + m));
                                        ...
                                        k(h, lol);
                                        d.beginPath();
                                        d.moveTo(v + X * .cos(D + G), r + X * .sin(D + G));
                                        d.lineTo(v +
                                            C * .cos(D + .PI - b), r + C * .sin(D + .PI - b));
                                        d.lineTo(v + C * .cos(D + .PI + b), r + C * .sin(D + .PI + b));
                                        d.lineTo(v + X * .cos(D - G), r + X * .sin(D - G));
                                        d.closePath();
                            ...
                            if (q.turrets.length === n.turrets.length)
                                for (E = 0; E < n.turrets.length; E++) d = n.turrets[E], 1 === d.layer && (v = d.direction + d.angle + m, w = d.offset * f, ba(y +
                                    w * .cos(v), R + w * .sin(v), d, x, t, f / x / d.size * d.sizeFactor, q.turrets[E].facing + p * m, p, h, q.turrets[E], F));
                            else throw Error("Mismatch turret number with mockup.");
            ...
            const Ra = (() => {
                    const a = q(0, .7, 1.5),
                        ...
                        c = class {
                            ...
                            draw(b, a, c, d) {
                                ...
                                let e = this.zeroMin ? 0 : .min(...this.data),
                                    f = .max(...this.data),
                                    h = f - e;
                                if (0 !== h) {
                            ...
                            getPeriodicAverage() {
                                var b = this.zeroMin ? 0 : .min(...this.data),
                                    a = .max(...this.data);
                                a = .1 * b + .9 * a;
                                var c = !1;
                                b = [];
                        ...
                        v = (() => {
                            let b = [];
                            for (let a = 0; a < 2 * B.gui.expectedMaxSkillLevel; a++) b.push(.log(4 * a / B.gui.expectedMaxSkillLevel + 1) / .log(5));
                            return a => b[a]
                        })();
                    ...
                    return c => {
                        ...
                        let d = 0;
                        oa++;
                        let n = .max(b.screenWidth, 16 * b.screenHeight / 9) / (1280 >= b.screenWidth ? 1280 : 1920 <= b.screenWidth ? 1920 : b.screenWidth),
                            q, y; {
                            let b = h();
                            d = b.getPrediction();
                            ...
                            F(l.white, 1);
                            F(l.guiblack, .1);
                            if (b.radial) g.save(), g.translate(b.screenWidth / 2, b.screenHeight / 2), g.rotate(.atan2(b.gameWidth / 2 - z.cx, b.gameHeight / 2 - z.cy)), g.translate(b.screenWidth / -2, b.screenHeight / -2), g.globalAlpha = 1, g.fillStyle = l.white, g.beginPath(), g.arc(-q + b.screenWidth / 2 + c * b.gameWidth / 2, -y + b.screenHeight / 2 + c * b.gameHeight / 2, c * b.gameWidth / 2, 0, 2 * .PI), g.fill();
                            else {
                                g.globalAlpha = 1;
                                g.fillStyle = l.white;
                            ...
                            let a = 30 * c;
                            if (b.radial) {
                                let d = 30 * .ceil(.sqrt(b.screenWidth * b.screenWidth + b.screenHeight * b.screenHeight) / c / c / 60) * c;
                            ...
                            if (b.radial) {
                                ...
                                let c = .atan2(b.gameWidth / 2 - z.cx, b.gameHeight / 2 - z.cy);
                                a = .cos(c);
                                d = .sin(c);
                                g.rotate(c)
                            }
                            da.forEach(function(a) {
                                if (a.render.draws) {
                                    ...
                                    a.id === A.playerid && 0 === (a.twiggle & 1) && (a.render.f = .atan2(U.target.y, U.target.x), b.radial && (a.render.f -= .atan2(b.gameWidth / 2 - z.cx, b.gameHeight / 2 - z.cy)), a.twiggle & 2 && (a.render.f += .PI));
                                    d = c * a.render.x - q;
                        ...
                        if (!b.hideGui) {
                            ...
                            do {
                                ...
                                let c = [],
                                    ...
                                    k = .min(.9 * b.screenWidth / h.width, .9 * b.screenHeight / h.height);
                                g.globalAlpha = .5;
                                ...
                                for (let [a, c] of d) {
                                    ...
                                    g.moveTo(.round(b.screenWidth / 2 + (a.x - h.width / 2) * k + 1 + .5 * n) + .5, .round(b.screenHeight / 2 + (a.y - h.height / 2) * k + 1 + .5 * n) + .5);
                                    g.lineTo(.round(d) + .5, .round(f) + .5)
                                }
                                g.stroke();
                                for (let {
                                        x: a,
                                    ...
                                    let t = -.PI / 4,
                                        ...
                                        v = M[x].position,
                                        m = .8 * n / v.axis;
                                    ba(c + .5 * n - m * v.middle.x * .cos(t), u + .5 * n - m * v.middle.x * .sin(t), q, .5, 1, m / q.size * 2, t, !0);
                                    g.strokeStyle = l.black;
                                    g.lineWidth = 2;
                                    G(c, u, n, n, !0)
                                }
                            } while (0);
                            if (b. && "joysticks" === U.control) {
                                let a = .min(.6 * b.screenWidth, .12 * b.screenHeight);
                                g.globalAlpha = .3;
                                g.fillStyle = "#ffffff";
                                g.beginPath();
                                g.arc(1 * b.screenWidth / 6, 2 * b.screenHeight / 3, a, 0, 2 * .PI);
                                g.arc(5 * b.screenWidth / 6, 2 * b.screenHeight / 3, a, 0, 2 * .PI);
                                g.fill()
                            }
                            b. && L(1.4); {
                                let c = b.screenWidth / 2,
                                    d = 20;
                                b. && (d += (b.canSkill ? (200 / 3 + 20) / 1.4 * a.get() : 0) + (b.canUpgrade ? 120 / 1.4 * k.get() : 0));
                                for (let b = Y.length - 1; 0 <= b; b--) {
                                    ...
                                    g.globalAlpha = .min(1, a.alpha);
                                    a.textobj.draw(f, c, d + 9, 14, l.guiwhite, "center", !0);
                                    d += 22;
                                    1 < a.status && (d -= 22 * (1 - .sqrt(a.alpha)));
                            ...
                            b. && L(1 / 1.4);
                            if (!b.) {
                                b.canSkill = 0 < A.points && A.skills.some(b => b.amount < b.);
                                ...
                                A.skills.forEach(function(a) {
                                    ...
                                    if (q) {
                                        ...
                                        p[h - 1].draw(x, .round(f +
                                            c / 2) + .5, e + 7.5, 10, q, "center", !0);
                                        w[h - 1].draw("[" + h % 10 + "]", .round(f + c - 3.75) - 1.5, e + 7.5, 10, q, "right", !0);
                                        q === l.guiwhite && b.clickables.stat.place(h - 1, f * n, e * n, c * n, 15 * n);
                                        u && R[h - 1].draw(q === t ? "MAX" : "+" + u, .round(f + c + 4) + .5, e + 7.5, 10, t, "left", !0);
                                        e -= 19
                                    }
                                });
                                b.clickables.hover.place(0, 0, e * n, .8 * c * n, .8 * (b.screenHeight - e) * n);
                                1 < A.points && r.draw("x" + A.points, .round(f + c - 2) + .5, .round(e + 15 - 4) + .5, 20, l.guiwhite, "right")
                            } {
                                let a = 25,
                                ...
                                K(c + 33, c + 330 * (.1 + .8 * (na ? .min(1, A.__s.getScore() / na) : 1)), d + a / 2, a - 3.5, l.green);
                                C.draw("Score: " + H.formatLargeNumber(A.__s.getScore()), c + 165, d + a / 2, a - 2, l.guiwhite, "center",
                                    !0);
                                g.lineWidth = 4;/*
                                if (//name color) {
                                N.draw(z.name, .round(c + 165) + .5, .round(d - 10 - 4) + .5, 32, l.yellow, "center")
                                } else {*/
                                N.draw(z.name, .round(c + 165) + .5, .round(d - 10 - 4) + .5, 32, l.guiwhite, "center")
                                //};// name color
                            }
                            b. && L(.8); {
                                ...
                                if (B.graphical.screenshotMode) W[6].draw("Arras.io", h + 200, m - 2, 15, l.guiwhite, "right");
                                    ...
                                    if (b.showDebug) {
                                        ...
                                        W[5].draw(" Speed: " + y.toFixed(2) + " gu/s" + (b && .005 <= b ? ` (${b.toFixed(2)} gu/s)` : ""), h + 200, m - 70, 10, l.guiwhite, "right");
                            ...
                            if (!B.graphical.screenshotMode) {
                                let c = b.screenWidth - 200 - 20,
                                    d = 48;
                                b. && (d += (b.canSkill ? 200 / 3 / 1.4 * a.get() : 0) + (b.canUpgrade && 40 + 114 * A.upgrades.length > 1.4 * c ? 100 / 1.4 * k.get() : 0));
                                0 < O.data.length && V.draw("Leaderboard", .round(c + 100) + .5, .round(d - 10) + .5, 18,
                                    l.guiwhite, "center");
                                for (let a = 0; a < O.data.length && (!b. || 6 > a); a++) {
                                    let b = O.data[a];
                                    K(c, c + 200, d + 7, 11 + B.graphical.barChunk, l.black);
                                    K(c, c + 200, d + 7, 11, l.grey);
                                    K(c, c + 200 * .min(1, b.score / na), d + 7, 10.5, b.barColor);
                                    ca[a].draw(b.label + ": " + H.handleLargeNumber(.round(b.score)), c + 100, d + 7, 9, l.guiwhite, "center", !0);
                                    let f = 14 / b.position.axis;
                                    ba(c - 21 - f * b.position.middle.x * .707, d + 7 + f * b.position.middle.x * .707, b.image, 1 / f, 1, f * f / b.image.size, -.PI / 4, !0);
                                    d += 18
                                }
                            }
                            b. && L(1 / 1.4); {
                                ...
                                if (b.canUpgrade) {
                                    ...
                                    A.upgrades.forEach(m => {
                                        ...
                                        m = M[m].position;
                                        let v = 60 / m.axis;
                                        ba(c + 50 - v * m.middle.x * .cos(la), d + 50 - v * m.middle.x *
                                            .sin(la), t, 1, 1, v / t.size, la, !0);
                                        m = (b.help[`KEY_CHOOSE_${x+1}`] || "").toLowerCase().trim();
                                        !b. && m ? (aa[q - 1].draw(t.name, c + 45, d + 100 - 6, 9.5, l.guiwhite, "center"), ea[q - 1].draw("[" + m + "]", c + 100 - 4, d + 100 - 6, 9.5, l.guiwhite, "right")) : aa[q - 1].draw(t.name, c + 50, d + 100 - 6, 9.5, l.guiwhite, "center");
                                        g.strokeStyle = l.black;
                                        g.globalAlpha = 1;
                                        g.lineWidth = 3;
                                        G(c, d, 100, 100, !0);
                                        0 !== ++x % 7 || b. ? c += 114 * a : (c = f, d += 114)
                                    });
                            ...
                            if (b.) {
                                b.canSkill = 0 < A.points && A.skills.some(b => b.amount < b.) && !b.canUpgrade;
                                ...
                                b.canSkill && (A.skills.forEach((a, k) => {
                                    ...
                                    if (!(0 >=
                                        ...
                                        0 < m && R[k].draw(m >= x ? "MAX" : "+" + m, .round(f + 50) + .5, 20 + 1.3 * d, d / 4, u, "center");
                                        g.strokeStyle = l.black;
                                        g.globalAlpha = 1;
                                        g.lineWidth = 3;
                                ...
                                }), 1 < A.points && r.draw("x" + A.points, .round(f) + .5, 40.5, 20, l.guiwhite, "left"))
                            }
                            L(1 / n, !0)
                        }
                    }
                ...
                Ta = (() => {
                    var a = m(),
                        ...
                        f = m();
                    let x = () => {
                            let a = [.round(b.finalKills[0].get()), .round(b.finalKills[1].get()), .round(b.finalKills[2].get())];
                    ...
                    return () => {
                        ...
                        let u = M[A.type].position,
                            t = 140 / u.axis;
                        ba(b.screenWidth / 2 - t * u.middle.x * .707 - 190 - 70, b.screenHeight / 2 - 35 + t * u.middle.x * .707 - 10, m, 1.5, 1, .5 * t / m.realSize, -.PI / 4, !0);
                        a.draw("lol you died", d, n - 80, 8, l.guiwhite, "center");
                        e.draw("Level " +
                            A.__s.getLevel() + " " + M[A.type].name, d - 170, n - 30, 24, l.guiwhite);
                        c.draw("Final score: " + H.formatLargeNumber(.round(b.finalScore.get())), d - 170, n + 25, 50, l.guiwhite);
                        h.draw("\u231a Survived for " + H.timeForHumans(.round(b.finalLifetime.get())), d - 170, n + 55, 16, l.guiwhite);
                        g.draw(x(), d - 170, n + 77, 16, l.guiwhite);
                        k.draw(q(), d - 170, n + 99, 16, l.guiwhite);
                        m = .ceil((b.respawnOn - Date.now()) / 1E3);
            ...
            window.$createProfile = (() => {
                ...
                return (a, c = -1, d = 200, k = -.PI / 4) => {
                    ...
                    a = M[a].position;
                    let m = .6 * n / a.axis;
                    ba(.5 * n - m * a.middle.x * .cos(k), .5 * d - m * a.middle.x * .sin(k), x, 1, 1, m / x.size, k, !0); - 1 !== c && (b.draw(x.name, .9 * n / 2, d - 6, d / 8 - 3, l.guiwhite, "center"), g.strokeStyle = l.black, g.globalAlpha = 1, g.lineWidth = 3, G(0, 0, n, d, !0));
            ...
            const Sa = (() => {
                    ...
                    m();
                    var c = [
                        ["Tip: You can view and edit your keybinds in the options .", "Tip: You can play on  by just going to arras.io on your phone!"],
                        ["Tip: You can have the shield and  bar be separated by going to the options .",
                            "Tip: If arras is having a low frame rate, you can try enabling low graphics in the options .", "Tip: You can make traps rounded with the classic trap setting in the options .", "Tip: You can create your own private server with the template in the link on the options .", "Tip: You can create your own theme with the custom theme makerin the link on the options ."
                        ],
                    ...
                    c = c[.floor(.random() * c.length)];
                    let g = c[.floor(.random() * c.length)];
                    return () => {
                        F(l.white, .5);
            ...
            let Oa = b. ? 0 : .max(0, 1 - .abs(Date.now() - new Date(2019, 11, 25)) / 20736E5);
            if (Oa) {
                ...
                let e = a.getContext("2d"),
                    ...
                    g = () => {
                        ...
                        for (let b of c) {
                            b.x += 5 / b.r + .random();
                            b.y += 12.5 / b.r + .random();
                            let c = 2 * .min(.4, .9 - b.y / a.height);
                            0 < c ? (e.globalAlpha = c, e.beginPath(), e.arc(b.x, b.y, b.r, 0, 2 * .PI), e.fill()) : b.gone = !0
                        }
                        .001 * a.width * Oa > .random() && c.push({
                            x: a.width * (1.5 * .random() - .5),
                            y: -50 - 100 * .random(),
                            r: 2 + .random() * .random() * 4
                        });
            ...
            if (!b. && (db && cb || eb)) {
                ...
                let e = a.getContext("2d"),
                    ...
                    k = () => {
                        ...
                        for (let b of g) {
                            ...
                            if (0 < h) e.strokeStyle = `rgba(${b.color[0]}, ${b.color[1]}, ${b.color[2]}, ${h})`, e.beginPath(), e.moveTo(d, f), e.lineTo(b.x, b.y), e.stroke();
                                ...
                                if (b.primary && !b.gone) {
                                    ...
                                    f = .5 * .random() + 3;
                                    h = 25 + 5 * .random();
                                    for (let a of [c[.floor(.random() * c.length)], c[.floor(.random() * c.length)]])
                                        for (let c = 0; c < d; c++) {
                                            let e = (c + .random()) / d * .PI * 2,
                                                k = f + .5 * .random();
                                            g.push({
                                                color: a,
                                                x: b.x,
                        ...
                        3E-5 * a.width > .random() && g.push({
                            color: c[.floor(.random() * c.length)],
                            x: a.width * .random(),
                            y: a.height - 10,
                            vx: 4 * .random() - 2,
                            vy: 5 * .random() - 15,
            ...
            const e = {
                ...
                servers: [{
                    ...
                    id: "a",
                    type: "1ffa",
                    code: "acoustic-bramble-tsunami",
                    at: p.glitch("acoustic-bramble-tsunami"),
                }, {
                   id: "d",
                    type: "0unk",
                    code: "z-unknown-pe6server",
                    at: p.glitch("regular-various-roadway"),
                    untrusted: !0
            ...
            (function(w) {
                function a(a) {
                    function e() {
                        setTimeout(function() {
                            !0 ===
                                x._options.checkOnLoad && (!0 === x._options.debug && x._log("onload->eventCallback", "A  loading is launched"), null === x._var.bait && x._creatBait(), setTimeout(function() {
                                    x.()
                                }, 1))
                        }, 1)
                    }
                ...
                a.prototype. = function(a) {
                    void 0 === a && (a = !0);
                    !0 === this._options.debug && this._log("", "An audit was requested " + (!0 === a ? "with a" : "without") + " loop");
                    if (!0 === this._var.checking) return !0 === this._options.debug && this._log("", "A  was canceled because there is already an ongoing"),
                        !1;
                    ...
                    !0 === this._options.debug && this._log("", "A  is in progress ...");
                    return !0
                };
                a.prototype._checkBait = function(a) {
                    ...
                    }!0 === this._options.debug && this._log("_checkBait", "A  (" + (this._var.loopNumber + 1) + "/" + this._options.loopMaxNumber + " ~" + (1 + this._var.loopNumber * this._options.loopCheckTime) +
        ...
        function(r) {
            const p = class {
                static now() {
                    return .min(.floor(Date.now() / 2E3) - 757382400, 268435455)
                }
                constructor() {
                    this.reset();
                    setInterval(() => {
                ...
                time() {
                    return .min(p.now() - this.startTime, 65535)
                }
                logEvent(a) {
        ...
        function(r, p, w) {
            ...
            class E {
                ...
                keyboardDown(e) {
                    switch (e.keyCode) {
                        case a.KEY_SPAWN:
                            if (a.died && (a.respawnOn <= Date.now() || e.shiftKey) && (this.spawn(a.playerName), a.died = !1, !a.)) {
                ...
                mouseDown(e) {
                    switch (e.button) {
                        case 0:
                            ...
                            let k = a.clickables.stat.(e); - 1 !== k ? this.talk("x", k) : -1 !== a.clickables.skipUpgrades.(e) ? a.clearUpgrades() : (e = a.clickables.upgrade.(e), -1 !== e ? this.talk("U", e) : this.set(4, !0));
                            break;
                        case 1:
                            this.set(5, !0);
                            break;
                ...
                mouseMove(e) {
                    ...
                    a.statHover = 0 === a.clickables.hover.({
                        x: e.clientX,
                        y: e.clientY
                    })
                }
                ...
                touchStart(e) {
                    ...
                    if (a.died && a.respawnOn <= Date.now()) this.spawn(a.playerName), a.died = !1;
                        ...
                        for (let x of e.changedTouches) {
                            ...
                            let e = x.identifier;
                            var p = a.clickables.stat.(k); - 1 !== p ?
                                this.talk("x", p) : -1 !== a.clickables.skipUpgrades.(k) ? a.clearUpgrades() : (p = a.clickables.upgrade.(k), -1 !== p ? this.talk("U", p) : (k = k.x < this.cv.width / 2, null === this.movementTouch && k ? this.movementTouch = e : null !== this.controlTouch || k || (this.controlTouch = e, this.set(4, !0))))
                        }
                        this.touchMove(e)
                    }
                }
                touchMove(a) {
                    ...
                    for (let k of a.changedTouches) {
                        ...
                        a = k.clientY;
                        var p = k.identifier;
                        this.movementTouch === p ? (e -= 1 * this.cv.width / 6, a -= 2 * this.cv.height / 3, p = .sqrt(e * e + a * a), e /= p, a /= p, -.3826834323650898 >
